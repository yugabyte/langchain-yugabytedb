...
def test_sync_chat_history() -> None:
    ...
    with syncpg_client() as sync_connection:
        YugabyteDBChatMessageHistory.drop_table(sync_connection, table_name)
...
async def test_async_chat_history() -> None:
    ...
    async with asyncpg_client() as async_connection:
        ...
        await YugabyteDBChatMessageHistory.adrop_table(async_connection, table_name)
        await YugabyteDBChatMessageHistory.acreate_tables(async_connection, table_name)
